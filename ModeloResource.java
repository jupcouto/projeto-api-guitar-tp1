...
import br.unitins.topicos1.guitar.service.ModeloService;
...
public class ModeloResource {
    ...
    @GET
    @Path("/find/{nome}")
    public List<Modelo> buscarPorNome(@PathParam("nome") String nome){
        return service.findByNome(nome);
    }

    @POST
    public Modelo incluir( @Valid ModeloDTO dto) {
